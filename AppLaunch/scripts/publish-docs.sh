...
docs_directory='./ibm-bluemix-mobile-services.github.io/API-docs/client-SDK/AppLaunch/Swift'
...
cd ibm-bluemix-mobile-services.github.io
git add .
git commit -m "Published docs for AppLaunch Swift SDK version ${version}"
git rebase master
